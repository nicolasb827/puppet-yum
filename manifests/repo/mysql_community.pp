...
class yum::repo::mysql_community(
    ...
    yum::managed_yumrepo { 'mysql-connectors-community':
      ...
      baseurl       => "http://repo.mysql.com/yum/mysql-connectors-community/el/${::operatingsystemmajrelease}/\$basearch/",
      enabled       => '1',
      gpgcheck      => '1',
    ...
    yum::managed_yumrepo { 'mysql-tools-community':
      ...
      baseurl       => "http://repo.mysql.com/yum/mysql-tools-community/el/${::operatingsystemmajrelease}/\$basearch/",
      enabled       => '1',
      gpgcheck      => '1',
      gpgkey        => 'file:/etc/pki/rpm-gpg/RPM-GPG-KEY-mysql',
      gpgkey_source => 'puppet:///modules/yum/rpm-gpg/RPM-GPG-KEY-mysql'
    ...
    yum::managed_yumrepo { 'mysql55-community':
      ...
      baseurl       => "http://repo.mysql.com/yum/mysql-5.5-community/el/${::operatingsystemmajrelease}/\$basearch/",
      enabled       => $enabled_55,
      gpgcheck      => '1',
      gpgkey        => 'file:/etc/pki/rpm-gpg/RPM-GPG-KEY-mysql',
      gpgkey_source => 'puppet:///modules/yum/rpm-gpg/RPM-GPG-KEY-mysql'
    ...
    yum::managed_yumrepo { 'mysql57-community':
